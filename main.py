...
def main():
    while True:
        ...
        try:
            depth = int(input((ru.ENTERDEPTH, fractal_info[ru.DEPTH][0], "-", fractal_info[ru.DEPTH][1])))
            size = float(input((ru.ENTERSIZE, {fractal_info[ru.SIZE][0], "-", fractal_info[ru.SIZE][1]})))
        except ValueError:
            print(ru.ENTERERROR)
